public class Sort {
    static Smft sfmt = new Sfmt(0);

    public static void main(String...args) {
            int[] array = new int[60];

        System.out.println("要素数" + 60 + "個(10000000回)");
        ...
        System.out.printf("ハイブリットソート: %.4f\n",(double)(end - start) / 1000);
    }
    ...
    public static void hybrid(int a[], int left,int right) {
        ...
        hybrid(a, left, indexL - 1);
        hybrid(a, indexR + 1, right);
        }
    }
}
